...
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "Fracktory Account")
        ...
        Column
        {
            ...
            Label  // A number of text items
            {
                ...
                text:
                {
                    ...
                    t = catalog.i18nc("@text", "- Stay flexible by setup and loading it anywhere")
                    full_text += "<p>" + t + "</p>"

                    t = catalog.i18nc("@text", "- Increase efficiency with a remote workflow on Fracktory printers")
                    full_text += "<p>" + t + "</p>"
