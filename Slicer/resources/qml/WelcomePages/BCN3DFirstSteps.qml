    ...
    Item
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "In this video we provide a clear and simple explanation on everything you'll need to know to start slicing your 3D models with Fracktory.")
            ...
            Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", 'Do you want to experiment beyond the standard mode?') +  "\n" + catalog.i18nc("@text", 'Learn how to configure your Fracktory printing parameters.') + ":"
                wrapMode: Text.WordWrap
                font: UM.Theme.getFont("medium")
                color: UM.Theme.getColor("text")
                renderType: Text.NativeRendering
